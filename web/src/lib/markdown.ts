...
// HTML review interactions use the exact source text. The visual document is
// a separate sandboxed preview, so source rows stay simple and keep the same
// line/character anchor contract as Markdown.
