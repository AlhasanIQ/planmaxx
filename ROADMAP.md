...
- Validate installation, updates, and review on clean macOS, Linux, and Windows
  systems.
- Keep the single-file review-bundle protocol and its doctor/snapshot tooling
  backwards compatible as the format evolves.
- Harden Codex, Claude Code, and Grok Build side-question and iteration
  integrations, with versioned live conformance probes.
